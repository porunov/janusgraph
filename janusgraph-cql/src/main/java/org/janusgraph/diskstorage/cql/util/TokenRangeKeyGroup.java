...
public class TokenRangeKeyGroup {

    private final Token routingToken;
    private final List<StaticBuffer> keys;
    private final List<ByteBuffer> rawKeys;

    public TokenRangeKeyGroup(int size, Token routingToken) {
        this.keys = new ArrayList<>(size);
        this.rawKeys = new ArrayList<>(size);
        this.routingToken = routingToken;
    }

    public TokenRangeKeyGroup(List<StaticBuffer> keys, List<ByteBuffer> rawKeys, Token routingToken) {
        this.keys = keys;
