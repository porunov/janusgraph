...
public class CQLKeyColumnValueStore implements KeyColumnValueStore {
    ...
    public CQLKeyColumnValueStore(final CQLStoreManager storeManager, final String tableName, final Configuration configuration, final Runnable closer) {
        ...
        asyncQueryExecutionService = new GroupingAsyncQueryExecutionService(configuration, session, storeManager.getKeyspaceName(), tableName,
            this::addTTLFunction, this::addTimestampFunction, singleKeyGetter, multiKeysGetter, storeManager.getExecutorService(), queryBackPressure);
