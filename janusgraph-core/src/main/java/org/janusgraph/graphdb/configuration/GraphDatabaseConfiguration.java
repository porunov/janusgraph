...
public class GraphDatabaseConfiguration {
    ...
    public static final ConfigOption<Integer> PARALLEL_BACKEND_EXECUTOR_SERVICE_MAX_POOL_SIZE = new ConfigOption<>(
        PARALLEL_BACKEND_EXECUTOR_SERVICE,
        "max-pool-size",
        "Maximum pool size for executor service. Ignored for `fixed` executor service and may be ignored " +
            "if custom executor service is used (depending on the implementation of the executor service).",
        ConfigOption.Type.LOCAL,
        Integer.class,
        Integer.MAX_VALUE);
    ...
    public static final ConfigOption<Long> PARALLEL_BACKEND_EXECUTOR_SERVICE_KEEP_ALIVE_TIME = new ConfigOption<>(
        PARALLEL_BACKEND_EXECUTOR_SERVICE,
        "keep-alive-time",
        "Keep alive time in milliseconds for CQL executor service. When the number of threads is greater than the `"+
    ...
    public static final ConfigOption<String> PARALLEL_BACKEND_EXECUTOR_SERVICE_CLASS = new ConfigOption<>(
        ...
        "The implementation of `ExecutorService` to use. " +
            "The class full name of the class which extends `"+ ExecutorService.class.getSimpleName()+"` which has either " +
