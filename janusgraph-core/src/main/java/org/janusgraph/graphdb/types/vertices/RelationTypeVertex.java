...
public abstract class RelationTypeVertex extends JanusGraphSchemaVertex implements InternalRelationType {
    ...
    public Iterable<IndexType> getKeyIndexes() {
        ...
        if (result==null) {
            List<SchemaSource.Entry> relatedEntries = getRelated(TypeDefinitionCategory.INDEX_FIELD,Direction.IN);
            result = new ArrayList<>(relatedEntries.size());
            for (Entry entry : relatedEntries) {
